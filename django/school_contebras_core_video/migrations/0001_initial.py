    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tags', models.ManyToManyField(related_name='videos', to='school_contebras_core_video.tag', verbose_name='Tags')),
            ],
            options={
                'verbose_name': 'Vídeo',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('video', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, related_name='video_media', to='school_contebras_core_video.video', verbose_name='Vídeo')),
            ],
        ),
    ]
